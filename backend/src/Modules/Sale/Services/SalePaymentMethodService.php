    ...
    private function payload(array $row, string $language, array $capabilities): array
    {
        ...
        return [
            ...
            'capabilities' => [
                ...
                'delayed_capture' => (bool) ($capabilities['delayed_capture'] ?? false),
                'partial_capture' => (bool) ($capabilities['partial_capture'] ?? false),
                'refund' => (bool) ($capabilities['refund'] ?? false),
                'partial_refund' => (bool) ($capabilities['partial_refund'] ?? false),
                'webhook' => (bool) ($capabilities['webhook'] ?? false),
                'reconcile' => (bool) ($capabilities['reconcile'] ?? false),
            ],
