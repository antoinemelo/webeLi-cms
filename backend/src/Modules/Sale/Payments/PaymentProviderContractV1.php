...
final class PaymentProviderContractV1
{
    ...
    public function capabilities(): array
    {
        return [
            ...
            'delayed_capture' => $this->provider->supports('capture'),
            'partial_capture' => $this->provider->supports('partial_capture'),
            ...
            'partial_refund' => $this->provider->supports('partial_refund'),
