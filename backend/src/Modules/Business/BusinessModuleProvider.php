...
final class BusinessModuleProvider implements ModuleProvider
{
    ...
    public function permissions(): array
    {
        return [
            ...
            ['key' => 'business.advanced_tools.manage', 'name' => 'Utiliser les outils avances Opérations', 'description' => 'Executer les rapprochements et reconstructions de projections CRM, PIM et storefront.'],
            ['key' => 'business.form_links.review', 'name' => 'Réviser les rattachements de formulaires', 'description' => 'Examiner et décider les rattachements ambigus entre soumissions et Relations.'],
    ...
    public function adminNavigation(): array
    {
        return [
            [
                ...
                'sort_order' => 140,
                'children' => [
                    ['key' => 'business.dashboard', 'label' => 'À traiter', 'route' => '/business', 'anyPermission' => ['business.crm.read', 'business.catalog.read', 'business.segment.read', 'business.mailing.read']],
                    ['key' => 'business.relations', 'label' => 'Relations', 'route' => '/business/relations', 'anyPermission' => ['business.crm.read', 'business.memo.read']],
                    ['key' => 'business.products', 'label' => 'Produits', 'route' => '/business/products-stock', 'permission' => 'business.catalog.read'],
                    ['key' => 'business.inventory', 'label' => 'Inventaire', 'route' => '/business/inventory', 'permission' => 'business.catalog.read'],
                    ['key' => 'business.marketing', 'label' => 'Offres et marketing', 'route' => '/business/offers-marketing', 'anyPermission' => ['business.catalog.read', 'business.segment.read', 'business.mailing.read']],
                    ['key' => 'business.settings', 'label' => 'Réglages', 'route' => '/business/settings', 'anyPermission' => ['business.catalog.write', 'business.catalog.discounts.write', 'business.catalog.stock.write', 'business.messaging.admin', 'business.advanced_tools.manage']],
                ],
            ],
        ];
    }
    ...
    public function adminRoutes(): array
    {
        return [
            ...
            $this->route('GET', '/admin/api/business/relations/{type}/{id}/360', 'BusinessRelation360ApiController@show'),
            $this->route('POST', '/admin/api/business/relations/{type}/{id}/tasks', 'BusinessRelation360ApiController@storeTask'),
            $this->route('PUT', '/admin/api/business/relations/{type}/{id}/roles', 'BusinessRelation360ApiController@updateRoles'),
            $this->route('POST', '/admin/api/business/relations/{type}/{id}/form-address', 'BusinessRelation360ApiController@issueFormAddress'),
            $this->route('GET', '/admin/api/business/form-links/pending', 'BusinessRelation360ApiController@pendingFormLinks'),
            $this->route('POST', '/admin/api/business/form-links/{id}/decision', 'BusinessRelation360ApiController@decideFormLink'),
            ...
            $this->route('DELETE', '/admin/api/business/pim/product-relations/{id}', 'BusinessPimApiController@deleteProductRelation'),
            $this->route('POST', '/admin/api/business/pim/products/{id}/relation-rules', 'BusinessPimApiController@storeProductRelationRule'),
            $this->route('DELETE', '/admin/api/business/pim/product-relation-rules/{id}', 'BusinessPimApiController@deleteProductRelationRule'),
            ...
            $this->route('GET', '/admin/api/business/pim/storefront-blocks/candidates', 'BusinessPimApiController@storefrontBlockCandidates'),
            $this->route('POST', '/admin/api/business/pim/storefront-blocks/preview', 'BusinessPimApiController@previewStorefrontBlock'),
    ...
    public function apiContracts(): array
    {
        return [
            ...
            $this->contract('admin.business.relations.360.v1', 'GET', '/admin/api/business/relations/{type}/{id}/360', 'business.crm.read'),
            $this->contract('admin.business.relations.tasks.store.v1', 'POST', '/admin/api/business/relations/{type}/{id}/tasks', 'business.crm.manage'),
            $this->contract('admin.business.relations.roles.update.v1', 'PUT', '/admin/api/business/relations/{type}/{id}/roles', 'business.crm.manage'),
            $this->contract('admin.business.relations.form_address.v1', 'POST', '/admin/api/business/relations/{type}/{id}/form-address', 'business.crm.manage'),
            $this->contract('admin.business.form_links.pending.v1', 'GET', '/admin/api/business/form-links/pending', 'business.advanced_tools.manage'),
            $this->contract('admin.business.form_links.decision.v1', 'POST', '/admin/api/business/form-links/{id}/decision', 'business.advanced_tools.manage'),
            ...
            $this->contract('admin.business.sale_activities.reconcile.v1', 'POST', '/admin/api/business/sale-activities/reconcile', 'business.advanced_tools.manage'),
            ...
            $this->contract('admin.business.catalog.inventory.index.v1', 'GET', '/admin/api/business/catalog/inventory', 'business.catalog.read'),
            ...
            $this->contract('admin.business.catalog.discounts.preview.v1', 'POST', '/admin/api/business/catalog/discounts/preview', 'business.catalog.discounts.write'),
            ...
            $this->contract('admin.business.pim.product_relations.delete.v1', 'DELETE', '/admin/api/business/pim/product-relations/{id}', 'business.catalog.write'),
            $this->contract('admin.business.pim.product_relation_rules.store.v1', 'POST', '/admin/api/business/pim/products/{id}/relation-rules', 'business.catalog.write'),
            $this->contract('admin.business.pim.product_relation_rules.delete.v1', 'DELETE', '/admin/api/business/pim/product-relation-rules/{id}', 'business.catalog.write'),
            ...
            $this->contract('admin.business.pim.storefront_projections.rebuild.v1', 'POST', '/admin/api/business/pim/storefront-projections/rebuild', 'business.advanced_tools.manage'),
            $this->contract('admin.business.pim.storefront_block_candidates.v1', 'GET', '/admin/api/business/pim/storefront-blocks/candidates', 'business.catalog.read'),
            $this->contract('admin.business.pim.storefront_block_preview.v1', 'POST', '/admin/api/business/pim/storefront-blocks/preview', 'business.catalog.read'),
        ...
        return [
            ...
            $this->crmBlueprint(
                ...
                [
                    ...
                    $this->enumField('relation_type', 'Type', ['related', 'accessory', 'alternative', 'bundle_candidate', 'replacement', 'upsell', 'cross_sell', 'similar'], 'identity', true, 'relation_type', ['scope' => 'business_pim']),
                    $this->field('sort_order', 'Ordre', 'number', 'identity', true, 'sort_order', ['scope' => 'business_pim']),
                    $this->field('created_at', 'Créé le', 'datetime', 'audit', false, 'created_at', ['system' => true, 'scope' => 'business_pim']),
                ],
                ['read' => $catalogRead, 'create' => $catalogWrite, 'update' => $catalogWrite, 'delete' => $catalogWrite, 'export' => $catalogRead],
