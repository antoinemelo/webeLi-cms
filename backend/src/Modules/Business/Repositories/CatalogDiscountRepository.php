    ...
    public function create(int $siteId, array $payload, ?int $actorId = null): array
    {
        ...
        $this->database()->run(
            ...
            [
                ...
                'scope_id' => $scopeId,
                'channel' => $this->choice($payload['channel'] ?? 'all', ['all', 'ecommerce', 'pos', 'admin'], 'discount_channel'),
    ...
    public function update(int $siteId, int $id, array $payload, ?int $actorId = null): ?array
    {
        ...
        $this->database()->run(
            ...
            [
                ...
                'scope_type' => $scopeType,
                'scope_id' => $scopeId,
                'channel' => $this->choice($payload['channel'] ?? $current['channel'], ['all', 'ecommerce', 'pos', 'admin'], 'discount_channel'),
