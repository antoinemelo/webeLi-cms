...
final class PublicStorefrontCartController
{
    ...
    public function show(): Response
    {
        ...
        $html='<!doctype html><html lang="'.$e($lang).'"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,follow"><title>Panier</title>'
            .'<link rel="stylesheet" href="'.$e($base.'/frontend/theme-default/assets/css/cart.css').'"></head><body data-storefront-channel="'.$e($channel).'" data-storefront-api-base="'.$e($apiBase).'" data-storefront-cart-url="'.$e($cartUrl).'" data-storefront-checkout-url="'.$e($checkoutUrl).'" data-app-base-path="'.$e(url_path('/')).'"><main class="cart-page" data-cart-page aria-labelledby="cart-title"><h1 id="cart-title">Votre panier</h1><div data-cart-status role="status" aria-live="polite"></div><div data-cart-error role="alert" aria-live="assertive"></div><div data-cart-lines aria-live="polite">Chargement…</div><div data-cart-summary></div><div data-cart-total></div><a class="cart-checkout" data-cart-checkout href="'.$e($checkoutUrl.'?channel='.rawurlencode($channel).'&lang='.rawurlencode($lang)).'">Passer la commande</a></main><script src="'.$e($base.'/frontend/theme-default/assets/js/storefront-cart.js').'" defer></script></body></html>';
