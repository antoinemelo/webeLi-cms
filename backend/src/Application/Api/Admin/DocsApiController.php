...
final class DocsApiController
{
    ...
    private function sectionPolicy(): array
    {
        return [
            'overview' => [
                'label' => 'Commencer',
                'description' => 'Trouver rapidement le bon guide selon votre objectif.',
                'audience_label' => 'Tous',
                'sort_order' => 0,
            ],
            'getting-started' => [
                'label' => 'Premiers pas',
                'description' => 'Découvrir l’interface et choisir un parcours adapté.',
                'audience_label' => 'Tous',
                'sort_order' => 10,
            ],
            'user-guide' => [
                'label' => 'Utiliser le CMS',
                'description' => 'Créer, organiser, relire et publier les contenus au quotidien.',
                'audience_label' => 'Tous',
                'sort_order' => 20,
            ],
            'administration' => [
                'label' => 'Configurer et administrer',
                'description' => 'Gérer les sites, langues, accès, modules et intégrations.',
                'audience_label' => 'Tous',
                'sort_order' => 30,
            ],
            'business' => [
                'label' => 'Catalogue, clients et ventes',
                'description' => 'Gérer les produits, contacts, offres, commandes et opérations métier.',
                'audience_label' => 'Tous',
                'sort_order' => 35,
            ],
            'installation' => [
                'label' => 'Installer',
                'description' => 'Préparer l’environnement et mettre une instance en service.',
                'audience_label' => 'Tous',
                'sort_order' => 40,
            ],
            'operations' => [
                'label' => 'Exploiter et dépanner',
                'description' => 'Sauvegarder, mettre à jour, surveiller et restaurer une instance.',
                'audience_label' => 'Tous',
                'sort_order' => 50,
            ],
            'api' => [
                'label' => 'Comprendre les API',
                'description' => 'Choisir la bonne interface et préparer une intégration.',
                'audience_label' => 'Tous',
                'sort_order' => 60,
            ],
            'public-api' => [
            ...
            'development' => [
                'label' => 'Développer et étendre',
                'description' => 'Comprendre l’architecture, ajouter une fonction et la vérifier.',
                'audience_label' => 'Tous',
                'sort_order' => 70,
            ],
            'reference' => [
                'label' => 'Références techniques',
                'description' => 'Retrouver les routes, commandes, permissions, schémas et contrats.',
                'audience_label' => 'Tous',
                'sort_order' => 80,
            ],
            'evaluation' => [
                'label' => 'Capacités, limites et preuves',
                'description' => 'Vérifier ce qui est pris en charge et consulter les preuves reproductibles.',
                'audience_label' => 'Tous',
                'sort_order' => 90,
            ],
        ];
