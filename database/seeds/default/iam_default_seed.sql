...
INSERT INTO "iam_users" ("id", "email", "email_normalized", "password_hash", "first_name", "last_name", "locale", "is_active", "disabled_at", "disabled_reason", "last_login_at", "password_reset_selector", "password_reset_token_hash", "password_reset_expires_at", "password_reset_requested_at", "password_reset_sent_at", "last_password_change_at", "created_at", "updated_at") VALUES (1, 'superadmin@webe.li', 'superadmin@webe.li', '$2y$12$IQ1A5lwkoWrPfypHOTGlT.aPMvbImII5mHeLb/wC4b/DaCmUyvLba', 'Super', 'Admin', 'fr-CH', 1, NULL, NULL, '2026-05-12 13:27:12', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-09 06:14:27', '2026-05-12 15:06:08');
INSERT INTO "iam_users" ("id", "email", "email_normalized", "password_hash", "first_name", "last_name", "locale", "is_active", "disabled_at", "disabled_reason", "last_login_at", "password_reset_selector", "password_reset_token_hash", "password_reset_expires_at", "password_reset_requested_at", "password_reset_sent_at", "last_password_change_at", "created_at", "updated_at") VALUES (2, 'antoinemelo@gmail.com', 'antoinemelo@gmail.com', '$2y$10$TGEH/AsOFmgvnFnxR3mjUOCy7OElnK14HvD8OEVcWNb4xG5yYrUQi', 'Antoine', 'Melo', 'fr-CH', 1, NULL, NULL, '2026-05-12 18:54:20', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-12 15:06:50', '2026-05-12 18:54:20');
...
INSERT INTO "iam_audit_logs" ("id", "actor_user_id", "action_key", "resource_type", "resource_id", "context_json", "ip_address", "user_agent", "created_at") VALUES (18, 1, 'iam.user.created', 'iam_user', 2, '{"email":"antoinemelo@gmail.com"}', '160.53.247.167', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Edg/148.0.0.0', '2026-05-12 15:06:50');
