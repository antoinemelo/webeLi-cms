...
- **Twig introuvable :** exécutez `composer install --working-dir backend`. N’utilisez `APP_TWIG_VENDOR_PATH` que pour une installation Twig autonome sans mapping `App\\`.
