...
| `sale_order_documents` | id, order_id, document_number, document_type, status, language, version, snapshot_json, text_snapshot, html_snapshot, issued_by_iam_user_id, issued_at, cancelled_at, cancellation_reason |
