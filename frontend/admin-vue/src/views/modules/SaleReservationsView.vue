...
type Reservation = {
  ...
  demand_kind?: 'sellable'|'bundle_component'; bundle_parent_sellable_id?: number; bundle_product_name?: string;
};
type Policy = {
