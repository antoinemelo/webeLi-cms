...
def _source_errors(root: Path) -> list[str]:
    checks = {
        ...
        "CRM timeline": (root / "frontend/admin-vue/src/views/modules/business/RelationTimeline.vue", "Ouvrir l’élément lié"),
        "CRM duplicate review": (root / "frontend/admin-vue/tests/e2e/sale-identity-review.spec.ts", "conflict"),
        "CRM segment and consent": (root / "frontend/admin-vue/tests/e2e/business-crm-smoke.spec.ts", "creates an explainable segment"),
