...
class CharacterizationBaseline(unittest.TestCase):
 ...
 def test_six_sqlite_databases_exist(self): self.assertEqual({'core.sqlite','iam.sqlite','forms.sqlite','cookies.sqlite','ai.sqlite','business.sqlite'},{p.name for p in (ROOT/'storage/database').glob('*.sqlite')})
